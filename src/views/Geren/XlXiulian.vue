<template>
  <div>
    <div>
      ...
      <div @click="addNa" title='以两倍修炼速率提升灵力，直接破镜'>闭关修炼</div>
    </div>
    <div>
...
export default {
  name: 'XlXiulian',
  computed: {
    ...mapState(['jjnum', 'csnum', 'lingli', 'atk', 'def', 'hp', 'mp', 'jjchongshu', 'jingjie', 'time', 'julingxl', 'linglixl'])
  },
  methods: {
    ...mapMutations(['addLingli', 'addN', 'addjj', 'addcsnum', 'addatk', 'adddef', 'addhp', 'addmp', 'addzhanli', 'addtime']),
    addLinglia () {
